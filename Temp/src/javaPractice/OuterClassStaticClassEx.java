...
public class OuterClassStaticClassEx
{
	...
	class Main
	{
	    ...
	    public static void main(String args[])
	    {
	       ...
	       OuterClassStaticClassEx outer = new OuterClassStaticClassEx();        
	       OuterClassStaticClassEx.InnerClass inner  = outer.new InnerClass();
	       ...
	       inner.display();
	        ...
	        Inner class*/
	       OuterClassStaticClassEx.InnerClass innerObject = new OuterClassStaticClassEx().new InnerClass();
